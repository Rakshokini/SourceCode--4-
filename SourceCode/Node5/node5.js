...
function OnrecievingAppendEntryRPC() {
    checkHeartBeat = setInterval(function () {
        //  if(currentRole !== 'Leader' && currentLeader !== null && startElection === false) {
        Received += 1;
        //}

        if (currentRole == 'Follower' && timeout === true && currentLeader !== null && Received > ReceivedLeaderCount && ReceivedVoteREquest === false) {
            ...
            console.log('First election node5');
            vote = setTimeout(() => {
...
function RequestVoteRPC() {
    ...
    if (followerlogInfo.length > 0) {
        ...
        var allServer = ['Node1', 'Node2', 'Node4', 'Node3'];
        // Edit later
...
function AppendEntryRPC() {
    ...
    Append = setInterval(function () {
        ...
        if (currentRole === 'leader') {
            var allServer = ['Node1', 'Node2', 'Node3', 'Node4'];
...
function StoreClientInfo(response = {}) {
    console.log('store request received: node5');
    if(currentRole === 'leader') {
        newStoreObject = {
        ...
        console.log('store request received: at leader node5', newStoreObject);
        ...
        console.log('store request received: at follower node5', StoreRejectMsg);
...
function RetrieveRequestInfo(response = {}) {
    console.log('retrieve request received: node5');
    if(currentRole === 'leader') {
        ...
        console.log('retrieve request received: leader node5', RetrieveAcceptMsg);
        ...
        console.log('retrieve request received: follower node5', RetrieveRejectMsg);
