...
function OnrecievingAppendEntryRPC() {
    checkHeartBeat = setInterval(function () {
        ...
        if (currentRole == 'Follower' && timeout === true && currentLeader !== null && startElection === false && Received > ReceivedLeaderCount && ReceivedVoteREquest === false) {
            ...
            console.log('First election node2');
            vote = setTimeout(() => {
...
function RequestVoteRPC() {
    ...
    if (followerlogInfo.length > 0) {
        ...
        var allServer = ['Node1', 'Node3', 'Node4', 'Node5'];
        var msg = {
            sender_name: nodeId,
...
function StoreClientInfo(response = {}) {
    console.log('store request received: node2');
    if(currentRole === 'leader') {
        newStoreObject = {
        ...
        console.log('store request received: at leader node2', newStoreObject);
        ...
        console.log('store request received: at follower node2', StoreRejectMsg);
...
function RetrieveRequestInfo(response = {}) {
    console.log('retrieve request received: node2');
    if(currentRole === 'leader') {
        ...
        console.log('retrieve request received: leader node2', RetrieveRejectMsg);
        ...
        console.log('retrieve request received: follower node2', RetrieveRejectMsg);
