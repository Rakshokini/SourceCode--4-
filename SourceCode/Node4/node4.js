...
function OnrecievingAppendEntryRPC() {
    checkHeartBeat = setInterval(function () {
        ...
        if (currentRole == 'Follower' && timeout === true && currentLeader !== null && Received > ReceivedLeaderCount && startElection === false && ReceivedVoteREquest === false) {
            ...
            console.log('First election node4');
            vote = setTimeout(() => {
...
function RequestVoteRPC() {
    ...
    if (followerlogInfo.length > 0) {
        ...
        var allServer = ['Node1', 'Node2', 'Node3', 'Node5'];
        // Edit later
...
function AppendEntryRPC() {
    ...
    // Edit later  setInterval(function () {
...
function StoreClientInfo(response = {}) {
    console.log('store request received: node4');
    if(currentRole === 'leader') {
        newStoreObject = {
        ...
        console.log('store request received: at leader node4', newStoreObject);
        ...
        console.log('store request received: at follower node4', StoreRejectMsg);
...
function RetrieveRequestInfo(response = {}) {
    console.log('retrieve request received: node4');
    if(currentRole === 'leader') {
        ...
        console.log('retrieve request received at leader: node4', RetrieveAcceptMsg);
        ...
        console.log('retrieve request received at follower: node4', RetrieveAcceptMsg);
